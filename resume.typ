...
#resume-item[
  - Multi-agent system framework forked from #link("https://github.com/openai/swarm", "openai/swarm")
  - SwarmX is agent & workflow
  - Swarm can be recursively included as agent in other swarms
  - Swarm can be dynamically created by existing swarm
]
// #resume-entry(
//   title: "BioV",
...
#resume-item[
  - AI-driven scientific research system with literature, idea, experiment, data visualization and paper writing
]
#resume-entry(
  title: "Omni WebUI",
...
#resume-item[
  - AI-driven development chatbot web ui
]
#resume-entry(
  title: "FastOAI",
...
#resume-item[
  - OpenAI-compatible API Server with multiple providers
  - Implemented Assistant API over chat completion api
]
#resume-entry(
  title: "Jupymcp",
...
#resume-item[
  - Model context protocol server for interacting with Jupyter notebook
  - Make LLM reach real data analysis procedure
]
// #resume-entry(
//   title: "Cotton2K",
