...
\begin{competences}
  \comptence{操作系统}{%
    \icon{\faUbuntu} Ubuntu Linux (7 年)
    \icon{\faLinux} Arch Linux （5 年）
  }
  \comptence{编程}{%
...
%======================================================================
\begin{itemize}
  %\item 2019 年``华为杯''第十六届中国研究生数学建模竞赛国家三等奖，使用 TensorFlow 构建移动通信无线传播模型。
  \item 对 Cotton2K 棉花生长模拟模型进行重构：\link{https://github.com/tcztzy/cottonmodel}{\texttt{cottonmodel}}
  \item 发表 2 篇合作者论文
\end{itemize}
